...
module ID
  ON_BOARDING_SKIP_BTN = 'on_boarding_panel_skip_button'
  NAVIGATION_ON_DEVICE_BTN = 'menu_item_on_device'
  SEARCH_OPEN_BTN = 'search_button'
  SEARCH_FIELD = 'search_src_text'
  FILE_NAME = 'list_explorer_file_name'
  EDITORS_ADD_BTN = 'toolbarAddButton'
  EDITORS_SETTINGS_BTN = 'toolbarSettingsButton'
